...
The `v0.1.4` assets are:

```text
cellarium-v0.1.4-linux-x86_64.tar.gz
cellarium-v0.1.4-linux-aarch64.tar.gz
cellarium-v0.1.4-macos-x86_64.tar.gz
cellarium-v0.1.4-macos-aarch64.tar.gz
cellarium-v0.1.4-windows-x86_64.zip
cellarium-v0.1.4-windows-aarch64.zip
SHA256SUMS
```
...
```sh
tar -xzf cellarium-v0.1.4-linux-x86_64.tar.gz
install -Dm755 cellarium "$HOME/.local/bin/cellarium"
```

Use `cellarium-v0.1.4-linux-aarch64.tar.gz` on ARM64 systems, including Jetson
...
```sh
tar -xzf cellarium-v0.1.4-macos-aarch64.tar.gz
chmod +x cellarium
