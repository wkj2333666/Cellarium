...
The `v0.1.10` assets are:

```text
cellarium-v0.1.10-linux-x86_64.tar.gz
cellarium-v0.1.10-linux-aarch64.tar.gz
cellarium-v0.1.10-macos-x86_64.tar.gz
cellarium-v0.1.10-macos-aarch64.tar.gz
cellarium-v0.1.10-windows-x86_64.zip
cellarium-v0.1.10-windows-aarch64.zip
SHA256SUMS
```
...
```sh
tar -xzf cellarium-v0.1.10-linux-x86_64.tar.gz
install -Dm755 cellarium "$HOME/.local/bin/cellarium"
```

Use `cellarium-v0.1.10-linux-aarch64.tar.gz` on ARM64 systems, including Jetson
...
```sh
tar -xzf cellarium-v0.1.10-macos-aarch64.tar.gz
chmod +x cellarium
