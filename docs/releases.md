...
The `v0.3.0` assets are:

```text
cellarium-v0.3.0-linux-x86_64.tar.gz
cellarium-v0.3.0-linux-aarch64.tar.gz
cellarium-v0.3.0-macos-x86_64.tar.gz
cellarium-v0.3.0-macos-aarch64.tar.gz
cellarium-v0.3.0-windows-x86_64.zip
cellarium-v0.3.0-windows-aarch64.zip
SHA256SUMS
```
...
```sh
tar -xzf cellarium-v0.3.0-linux-x86_64.tar.gz
...
```sh
tar -xzf cellarium-v0.3.0-macos-aarch64.tar.gz
chmod +x cellarium
